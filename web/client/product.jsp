<%-- 
    Document   : product
    Created on : Jun 20, 2022, 8:09:02 PM
    Author     : thanh
--%>
            ...
            <div class="col-md-2">
                ...
                <div class="category">
                    ...
                    <c:forEach items="${listCategories}" var = "category">
                         <a class="pt-4" href="#"
                        style="color: #8400e7 !important; margin-left: 5px;font-size: 20px">${category.getCategory()}</a>
                        <c:forEach items="${category.litsSubCategories}" var="subCategory">
